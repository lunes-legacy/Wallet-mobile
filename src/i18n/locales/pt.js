...
export default {
  ...
  YOU_WILL_RECEIVE_CODE_SMS: 'Você irá receber um código via SMS para validar seu telefone',
  ...
  TRANSACTION_NO_SOLUTION: 'Não foi possível efetuar a transação. Erro: TRANSACTION_NO_SOLUTION',
  SAVE: 'SALVAR',
  VERSION: 'Versão',
