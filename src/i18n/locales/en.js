export default {
  ...
  INVALID_PASSWORD:
    'Password is invalid. It must contain at least 8 chars, lowercase, uppercase, numbers and special',
  ...
  CITY: 'City',
  CHANGE_PASSWORD_TITLE: 'You will receive on your email a link to change your password',
  ...
  YOU_WILL_RECEIVE_CODE_SMS: 'You will receive a SMS code to validate your phone number',
  ...
  TRANSACTION_NO_SOLUTION: 'Could not execute transaction. Error: TRANSACTION_NO_SOLUTION',
  SAVE: 'SAVE',
