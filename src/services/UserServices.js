...
const isValidUser = ({ user }) => isObject(user) && user.accessToken;
...
const saveItemUserInStore = (value, item = '@email') => AsyncStorage.setItem(item, value);

const getItem = (item = '@email') => AsyncStorage.getItem(item);

export { isValidUser, isValidSignin, isValidSignUp, saveItemUserInStore, getItem };
