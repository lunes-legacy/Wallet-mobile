...
export default class SendPayment extends React.Component {
  ...
  getQuotationAmount() {
    if (
      ...
      const btc =
        this.props.displayPriceBTC.DISPLAYPRICE * this.props.balanceData.confirmed_balance;
  ...
  render() {
    return (
      ...
      >
        <Container>
          <StatusBar backgroundColor={BosonColors.$bosonPrimary} barStyle="light-content" />
          <Root>
            <View style={styles.container}>
                ...
                <View style={styles.containerAmountAvailable}>
                  <View style={styles.amount}>
                    ...
                    <Text style={styles.textAmount}>
                      {this.props.balanceData ? this.props.balanceData.confirmed_balance : 0}
                    </Text>
                  </View>
                  <View>
                    <Text style={styles.text}>{this.props.displayPriceBTC.DISPLAYPRICE}</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.containerInner}>
                <Text style={styles.textAmountToType}>{I18n.t('typeYourAmountCoin')}</Text>
                <TextInput
              ...
              <View style={styles.containerInner}>
                <View style={{ flexDirection: 'row' }}>
                  ...
                  <View style={styles.quotationAmount}>
                    <Text style={styles.textAmountToType}>{I18n.t('VALUE_CURRENCY_LABEL')}</Text>
              ...
              <View style={[styles.containerInner, { width: Dimensions.get('window').width - 50 }]}>
                <Button
                  rounded
                  block
                  success
