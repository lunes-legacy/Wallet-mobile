...
const mapDispatchToProps = dispatch => bindActionCreators({ getHistoric }, dispatch);

export default connect(mapStateToProps, mapDispatchToProps)(HistoricTransaction);
