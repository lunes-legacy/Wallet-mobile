        ...
        <ScrollView style={{ width: Dimensions.get('window').width }}>
          ...
          <View style={styles.fullnameContainer}>
            ...
            <View style={styles.containerQuotation}>
              <Text style={styles.textQuotation}>{this.props.ticker.BTC.DISPLAYPRICE}</Text>
              <Svg width={Dimensions.get('window').width} height="60">
                <Defs>
                  ...
                  >
                    <Stop offset="0%" stopColor={bosonColor.$bosonLightGreen} stopOpacity="1" />
          ...
          <View style={styles.container}>
            <LunesIconCalendar size={30} color={'#fff'} style={styles.iconForm} />
            <TextInput
              maxLength={10}
              underlineColorAndroid={'transparent'}
              style={styles.input}
          ...
          <TouchableOpacity onPress={() => this.openModal('SUPPORT')}>
            <View style={styles.footer}>
              ...
              />
              <Text style={{ paddingLeft: 25, color: bosonColor.$bosonLightGreen }}>
                {I18N.t('SUPPORT')}
              </Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => this.openModal('ABOUT')}>
            <View style={styles.footer}>
              ...
              <LunesIconAbout
                ...
                style={styles.iconForm}
              />
              <Text style={{ paddingLeft: 30, color: bosonColor.$bosonLightGreen }}>
                {I18N.t('ABOUT')}
              </Text>
            </View>
          </TouchableOpacity>
