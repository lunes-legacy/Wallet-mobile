      ...
      return (
        <TouchableOpacity onPress={() => this.props.onPress()}>
          <View style={[atomicBtnStyleDefault.atomBtn, atomBtnLarge]}>
            <Text style={atomicBtnStyleDefault.quarkText}>{this.props.text}</Text>
          </View>
        </TouchableOpacity>
      );
    }
      ...
      return (
        <TouchableOpacity onPress={() => this.props.onPress()}>
          <View style={[atomicBtnStylePrimary.atomBtn, atomBtnLarge]}>
            <Text style={atomicBtnStylePrimary.quarkText}>{this.props.text}</Text>
          </View>
        </TouchableOpacity>
      );
    }
      ...
      return (
        <TouchableOpacity onPress={() => this.props.onPress()}>
          <View style={[atomicBtnStyleDisabled.atomBtn, atomBtnLarge]}>
            <Text style={atomicBtnStyleDisabled.quarkText}>{this.props.text}</Text>
          </View>
        </TouchableOpacity>
      );
    }
  ...
  roundedPrimaryButton() {
    if (this.props.type === 'rounded') {
      return (
        ...
        >
          <View>
            <Text style={atomicBtnStyleRounded.quarkText}>{this.props.text}</Text>
          </View>
        </TouchableHighlight>
      );
    }
