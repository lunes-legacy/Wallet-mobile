...
class Header extends Component {
  ...
  renderIconHamburguerMenu() {
    ...
    return (
      <TouchableHighlight style={{ padding: MenuButton.padding }} onPress={onPress}>
        <Text>
  ...
  renderDropdown() {
    ...
    return (
      ...
      >
        <Entypo name="dots-three-vertical" size={20} color={MenuButton.back.color} />
      </TouchableOpacity>
    );
  }
          ...
          >
            <View style={styles.modalContainer}>
              <View style={styles.innerContainer}>
                ...
                >
                  <Text style={{ color: '#fff' }}>{this.props.I18n.t('LOGOUT')}</Text>
                </Button>
              </View>
            </View>
          </Modal>
...
const mapDispatchToProps = dispatch => bindActionCreators({ requestSignout }, dispatch);
