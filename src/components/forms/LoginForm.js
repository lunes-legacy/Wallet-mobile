...
class LoginForm extends Component {
  ...
  renderEyePassword = () => (
    <View style={styles.containerPassword}>
      <TouchableOpacity onPress={() => this.props.chackeChange('secureTextEntry')}>
  ...
  getNameForm = () =>
    (this.props.isSigninForm ? this.props.I18n.t('SIGNIN') : this.props.I18n.t('SIGNUP'));

  isPasswordMatch = () => this.props.user.password === this.props.user.confirmPassword;
  ...
  checkButtonIsDisabled() {
    ...
    } else if (this.props.isSigninForm && this.props.user.email && this.props.user.password) {
      return this.renderButtonSubmit();
    }
  ...
  renderButtonSubmit() {
    return (
      <View style={styles.btnSubmit}>
        <Button rounded block success style={{ height: 50 }} onPress={this.props.submitButton}>
          <Text uppercase={false}>{upperCaseFirstLetterText(this.getNameForm())}</Text>
        </Button>
      </View>
    );
  }
  ...
  renderDisabledButton() {
    return (
      <View style={styles.btnSubmit}>
        <LunesGradientButton text={upperCaseFirstLetterText(this.getNameForm())} />
      </View>
    );
  }
