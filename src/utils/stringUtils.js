...
export const upperCaseFirstLetterText = text => {
  const UpperCase = text
    .toLowerCase()
    .replace(/^[\u00C0-\u1FFF\u2C00-\uD7FF\w]|\s[\u00C0-\u1FFF\u2C00-\uD7FF\w]/g, letter => {
...
function alertSuccess(message, isShow, callbackOnClose, callbackOnConfirmation) {
  return (
    <LunesAlert
      isShow={isShow}
      type="success"
...
export const handleSuccess = (success, callbackOnClose, callbackOnConfirmation) => {
...
export const handleErrors = (error, callbackOnClose, callbackOnConfirmation) => {
  const renderAlertError = msg => alertError(msg, true, callbackOnClose, callbackOnConfirmation);
