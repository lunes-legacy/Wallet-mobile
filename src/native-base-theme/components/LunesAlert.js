...
import { LunesIconError, LunesIconSuccess, LunesIconWarning } from '../components/LunesCustomIcon';
    ...
    if (this.props.type === 'error' && this.state.isVisible) {
      return (
        <View style={{ flex: 1, width: '100%' }}>
          <View style={[styles.dialogHeader, { backgroundColor: BosonColors.$bosonDarkPink }]}>
