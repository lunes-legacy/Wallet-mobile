...
export default class LunesSwiper extends Component {
  ...
  render() {
    ...
    const onScroll = Animated.event([{ nativeEvent: { contentOffset: { x: animatedValue } } }]);
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        {this.props.dots && (
          <View>
            {this.props.shadow && (
              <View style={[styles.shadowContainer, styles.shadow, this.props.shadowStyle]} />
            )}
            <View style={[styles.dotContainer, { bottom: this.props.dotsBottom || 29 }]}>
              {this.props.children.map((slide, i) => (
                <View
                  key={`swiper-dot-${i}`}
                  style={[
                    ...
                    this.props.dotStyle,
                    {
                      backgroundColor: this.props.dotsColor || 'rgba(0, 0, 0, 0.25)'
                    }
                  ]}
                />
              ))}
              ...
              {this.props.children.map((slide, i) => (
                <Animated.View
                  ...
                  style={[
                    ...
                    {
                      backgroundColor: this.props.dotsColorActive || 'rgba(0, 0, 0, 0.75)',
