...
export default class LunesPIN extends React.Component {
  ...
  renderKeyboardInput(position) {
    return (
      ...
      >
        <Text style={[styles.keyboardInput, this.renderKeyboardGreen()]}>{position}</Text>
      </TouchableOpacity>
    );
  }
  ...
  render() {
    return (
      <View>
        ...
        >
          ...
          <View>
            <Text style={styles.instructions}>
              ...
              {this.props.toValidate ? I18N.t('VALIDATE') : I18N.t('SIGNUP')} {I18N.t('YOUR_PIN')}
            </Text>
          </View>
        ...
        <View style={[styles.container, { width: Dimensions.get('window').width - 50 }]}>
          ...
          <View style={styles.row}>
            <View style={[styles.box]}>
              ...
              >
                <Entypo name="erase" size={25} color={BosonColors.$bosonLightGreen} />
              </TouchableOpacity>
            </View>
