export default {
  ...
  balance: 'balance',
  BALANCE: 'Balance',
  typeYourAmountCoin: "Type the coin's amount",
  typeHere: 'type here',
  optionsSent: 'Options to send',
  SOMETHING_ERROR: 'Something went wrong! Verify with our support.',
  WRONG_PASSWORD: 'Your password is not secure. Try other!',
  USER_NOT_FOUND: 'User not found',
  ERROR_AUTHENTICATE: 'Error on authentication',
  NOT_CONNECTED: 'You must be online to access your Lunes Wallet.',
  ...
  ERROR: 'Error',
  ERROR_ON_SAVE_PIN: 'Error saving the PIN',
  TYPE_PIN_CODE: 'Type a code of 4 digits to',
  YOUR_PIN: 'your PIN',
  VALIDATE: 'validate',
  WELCOME: 'Welcome!',
  ...
  ANALYTICS: 'ANALYTICS',
  ANALYTICS_MSG:
    'Follow the rise and fall of the cryptocoins market through our modern and pratical graphics.',
  DO_YOUR_BACKUP: 'Do your Backup',
  DO_YOUR_BACKUP_MSG:
    'We do not store your coins on our servers, they are your property, therefore they are in your possession. So, make sure to save ',
  DO_YOUR_BACKUP_MSG_2: 'your private keys and backup them.',
  BUY_COINS: 'Buy Coins',
  BUY_COINS_MSG:
    'Buy cryptocoins quickly and safely, without bureaucracy. Add credits paying by bank ',
  BUY_COINS_MSG_2: 'invoice or with your credit card.',
  TRANSACTIONS_P2P: 'Transactions P2P',
  TRANSACTIONS_P2P_MSG:
    'Send and recieve peer to peer payments to, and from, any place in the world. Our transactions are fast, safe and cheap.',
  CONTINUE: 'Continue',
  START: 'Start',
  ...
  DO_BACKUP: 'Do Backup',
  CONFIRM_BACKUP_HEADER: 'Confirm the backup words',
  CONFIRM_BACKUP: 'I confirm the Backup',
  CONFIRM_WORDS: 'CONFIRM WORDS',
  SEED_BACKUP_MSG:
  ...
  JUST_SENT: 'just sent',
  OF_YOUR_WALLET_LUNES: 'of your Lunes Wallet',
  ...
  MENU_BACKUP: 'Back up the Wallet',
  ...
  YOUR_TRANSACTION_HISTORIC: 'Your history of transactions',
  ...
  IF_YOU_NOT_HAVE_SEED_GENERATE:
    "If you doesn't have a seed to import, generate the seed",
  ...
  ERROR_GENERATE_NEW_SEED: 'Error on generate a new seed',
  INVALID_WORDS: 'Invalid Words',
  ERROR_ADDRESS_BY_SEED: 'Error on generate an address',
  SUCCESS_ON_GENERATE_ADDRESS: 'Success on generate an address',
  ...
  ERROR_ON_SET_LEASE: 'Error to confirm the leasing',
  SUCCESS_ON_SET_LEASE: 'Success to confirm the leasing',
  ERROR_ON_CANCEL_LEASE: 'Error to cancel the leasing',
  SUCCESS_ON_CANCEL_LEASE: 'Success to cancel the leasing',
