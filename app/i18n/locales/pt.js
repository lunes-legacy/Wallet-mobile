...
export default {
  ...
  SOMETHING_ERROR: 'Algo deu errado. Verifique com nosso suporte',
  WRONG_PASSWORD: 'Senha inválida ou não segura. Tente outra!',
  ...
  WELCOME_MSG: 'Muito obrigado por escolher a Lunes Wallet como',
  WELCOME_MSG_2:
  ...
  LEASING_MINING_NODE_ADDRESS: 'Endereço Lunes para o leasing',
  ERROR_ON_SET_LEASE: 'Erro ao confirmar o leasing',
  SUCCESS_ON_SET_LEASE: 'Sucesso ao confirmar o leasing',
  ERROR_ON_CANCEL_LEASE: 'Erro ao cancelar o leasing',
  SUCCESS_ON_CANCEL_LEASE: 'Sucesso ao cancelar o leasing',
